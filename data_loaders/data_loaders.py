...
class AxialMRIDataLoader(DataLoader):
    def __init__(self, root, batch_size, shuffle=True, num_workers=0, split='train', num_samples=-1,
                 join_transforms=None, image_transforms=None, target_transforms=None):
        self.dataset = AxialMRIDataset(root, split, num_samples, join_transforms, image_transforms, target_transforms)
